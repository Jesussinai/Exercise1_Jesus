...
//import static org.junit.Assert.assertEquals; //commented - jesus
...
public class ClsWebElements 
{
    ...
    public WebElement getGetWebElement(By by)
    {
        try
        {
        	ClsReport.fnLog(Status.INFO, "Step - Get Web Element: " + by.toString(), false); // change Status.INFORMATION to Status.INFO - jesus
    ...
    public boolean SendKeys(final By by, String pValue) 
	{
    	...
    	//return null; // commented - jesus
	}
    
    public boolean SendKeys(final String pstrLocator, String pValue) 
    {
    	return SendKeys(By.xpath(pstrLocator), pValue); // change By.xpaths to By.xpath - jesus
    }
